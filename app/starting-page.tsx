    ...
    <main className="flex items-center justify-center pt-12 sm:pt-16 lg:pb-4 w-[90%] sm:w-[70%] 2xl:w-[50%] 2xl:max-w-640 mx-auto">
      <div className="flex-1 flex flex-col items-center gap-4 lg:gap-12 min-h-0">
        ...
        <div className="flex flex-col gap-4 lg:gap-8 mx-auto max-w-100">
          ...
          <p className='text-base xl:text-lg'>You don't have your own letterboxd account?
            Enter a <a href="https://letterboxd.com/members/" rel="noopener noreferrer"
              className="text-bright-green underline underline-offset-3 hover:text-white active:text-bright-blue">popular reviewer's username</a>.
